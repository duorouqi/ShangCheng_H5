<template>
	<view class="box">
		...
		<u--form :model="form" ref="uForm" labelWidth='auto' :rules="rules">
			...
			<view>
				<u-form-item label="推荐类型:" v-if="false">
					<view class="input-hxbh input-type">
			...
			<view class="box-information">
				<view class="box-information-one">
					...
					<u-form-item class="lx" label="类型:" borderBottom @click="showlx = true;actions=lxlist" prop="lx">
						<view class="input-type">
							<u--input v-model="form.lx" fontSize='12px' disabled disabledColor="#ffffff" placeholder="请选择"></u--input>
					...
					<u-form-item class="bzcmj" prop="bzcts" label="标准层套数:" borderBottom
						...
						<view class="input-type">
							<u--input v-model="form.bzcts" fontSize='12px' disabled disabledColor="#ffffff" placeholder="请选择">
							</u--input>
							<u-icon slot="right" name="arrow-right"></u-icon>
						</view>
					</u-form-item>
					<u-form-item class="sfdtrh" prop="sfdtrh" label="是否独梯入户:" borderBottom
						...
						<view class="input-type">
							<u--input v-model="form.sfdtrh" fontSize='12px' disabled disabledColor="#ffffff" placeholder="请选择">
							</u--input>
							<u-icon slot="right" name="arrow-right"></u-icon>
						</view>
					</u-form-item>
				...
				<view>
					...
					<u-form-item class='kfpj' prop="xmzt" label="项目状态:" borderBottom
						...
						<view class="input-type">
							<u--input v-model="form.xmzt" fontSize='12px' disabled disabledColor="#ffffff" placeholder="请选择"></u--input>
						</view>
					</u-form-item>
			...
			<view>
				<u-form-item prop="name" label="推荐人联系方式:">
					<view class="input-type">
						<u-input fontSize='12px' placeholder="请输入" style="width: 300rpx;" v-model="form.phone" @change="change" disabled>
						</u-input>
					</view>
				</u-form-item>
			</view>
				...
				this.$refs.uForm.validate().then(async res => {
					try {
						...
						try {
							...
							let datas = {
								"data": [{
									...
									"mainTable": {
										...
										// "txtxt": "",
										// "jrxxy": "",
										"tjr": JSON.parse(sessionStorage.getItem(
												"user"))
											.userid,
										"tjsh": "0",
										"tjrtxt": this.form.xm
								...
								"header": {
									...
									"Md5": md5("Addbzk" + 123 + this.setTime())
								}
							}
							let res = await postAddbzk(JSON.stringify(datas));
							...
							// postAddbzk(JSON.stringify(data)).then(async res => {
								
							// 	if (res.status == 1) {
							// 		setTimeout(async ax => {
							// 			await this.postUpdatebzkfj(res
							// 				.datajson
							// 				.billid);
							// 		}, 10000)
							// 		uni.navigateBack({
